...
import { conversationSchema, conversationMessageSchema } from '../validation/schemas.js';
...
export class ConversationRepository extends BaseRepository {
     ...
     */
    async getRoundtables(projectId) {
        try {
            return await this.prisma.conversation.findMany({
                where: {
                    projectId,
...
export class ConversationMessageRepository extends BaseRepository {
     ...
     */
    async getUnprocessedMessages(characterId) {
        try {
            return await this.prisma.conversationMessage.findMany({
                where: {
                    characterId,
